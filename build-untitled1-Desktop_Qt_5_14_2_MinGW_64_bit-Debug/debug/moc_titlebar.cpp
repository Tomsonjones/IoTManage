...
QT_MOC_LITERAL(1, 9, 15), // "miniSizedSignal"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 14), // "maxSizedSignal"
QT_MOC_LITERAL(4, 41, 11) // "closeSignal"

    },
    "Titlebar\0miniSizedSignal\0\0maxSizedSignal\0"
    "closeSignal"
};
...
void Titlebar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->miniSizedSignal(); break;
        case 1: _t->maxSizedSignal(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Titlebar::miniSizedSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Titlebar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Titlebar::maxSizedSignal)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Titlebar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Titlebar::closeSignal)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Titlebar::miniSizedSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Titlebar::maxSizedSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Titlebar::closeSignal()
{
