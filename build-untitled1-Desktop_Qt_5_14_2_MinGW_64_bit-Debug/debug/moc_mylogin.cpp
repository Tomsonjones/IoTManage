...
QT_MOC_LITERAL(4, 19, 10), // "showStatus"
QT_MOC_LITERAL(5, 30, 11), // "LoginAction"
QT_MOC_LITERAL(6, 42, 14), // "RegisterAction"
QT_MOC_LITERAL(7, 57, 8) // "unfreeze"

    },
    "Mylogin\0display\0\0a\0showStatus\0LoginAction\0"
    "RegisterAction\0unfreeze"
};
...
void Mylogin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->showStatus((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->LoginAction(); break;
        case 3: _t->RegisterAction(); break;
        case 4: _t->unfreeze(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Mylogin::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Mylogin::display)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Mylogin::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Mylogin::showStatus)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Mylogin::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Mylogin.data,
    qt_meta_data_Mylogin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 1
void Mylogin::showStatus(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
